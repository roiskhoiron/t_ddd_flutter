...
// in t_ddd_flutter/test/infrastructure/repository/user_repository_impl_test.dart.
...
class MockUserRepositoryImpl extends _i1.Mock
  ...
  @override
  _i3.Future<_i5.User?> getUserById(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getUserById,
          [id],
        ),
  ...
  @override
  _i3.Future<dynamic> register(_i5.User? data) => (super.noSuchMethod(
        Invocation.method(
          #register,
          [data],
        ),
